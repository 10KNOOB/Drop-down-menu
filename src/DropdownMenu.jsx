  ...
  return (
    <div className="flex h-screen items-center justify-center">
      <div className="relative ">
        <div className="flex justify-between items-center w-64 border p-3 rounded bg-gray-100">
        ...
        {isOpen && (
          <div className="absolute left-0 top-11 rounded-b-md w-64 border bg-white">
